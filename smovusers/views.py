...
def get_application_group():
    group, created = Group.objects.get_or_create(name="smartmoving apps")
    return group


class IsSmartMovingApp(IsAuthenticated):
...
class UserView(viewsets.ModelViewSet):
    ...
    permission_classes = (
        IsSuperUserOrStaff
        | ((IsListView | IsCreateView) & IsSmartMovingApp)
...
class ObtainAuthToken(views.ObtainAuthToken):
    ...
    permission_classes = (IsSuperUserOrStaff | IsSmartMovingApp,)
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            SmartMovingProfile.objects.get(user=user)
        except SmartMovingProfile.DoesNotExist:
