...
# Test that unathenticated user cant retrieve any itinerary

# Test that a user creates an itinerary and its his
# Test that retrieve his itineraries AND ONLY HIS
# Test that users cant retrieve ither users itinerary by id
